...
export default function ServicesDetailItem({
  ...
  return (
    <div className="grid grid-cols-12 max-xl:gap-20 max-xl:flex max-xl:flex-col w-[80%] max-w-[1800px] m-auto ">
      ...
      <div className="col-span-6  max-xl:w-[100%] w-[80%] max-w-[1500px] m-auto ">
